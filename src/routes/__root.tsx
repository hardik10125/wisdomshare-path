...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Wisdom Share — Learn. Share. Grow Together." },
      {
        name: "description",
        content:
          "The AI-powered educational social network. Share study materials, connect with learners, and get instant help from an AI study assistant.",
      },
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html:
              "try{var t=localStorage.getItem('ws-theme');if(t==='dark'||(!t&&window.matchMedia('(prefers-color-scheme: dark)').matches))document.documentElement.classList.add('dark');}catch(e){}",
          }}
        />
      </head>
      <body>
